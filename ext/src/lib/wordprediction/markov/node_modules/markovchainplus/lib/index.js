        ...
        for (var i = 0; i < words.length - 1; i++) {
           ...
           for (var j = 0; j < 4; j++) {
              if (curWords[j] !== undefined) {
                ...
                if (/[A-Z]/.test(curWords[j][0]) && _this.wordBank[curWords[j].toLowerCase()]) {
                  curWords[j] = curWords[j].toLowerCase();
                ...
                else if (/[a-z]/.test(curWords[j][0]) && _this.wordBank[upper]) {
                  //_this.wordBank[upper] = curWords[j];
                  //combine the uppercase version into a lowercase - don't delete
                  //what about other keys/wordbanks containing this word?
                }
              }
           }
