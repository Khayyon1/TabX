...
var models = [];
models.push(require('./models/library-model-medium'));
models.push(require('./models/blogs-model-medium'));
...
var libraryModelMedium = new WordPrediction(models[0]);
module.exports.libraryModelMedium = libraryModelMedium;
var blogsModelMedium = new WordPrediction(models[1]);
module.exports.blogsModelMedium = blogsModelMedium;